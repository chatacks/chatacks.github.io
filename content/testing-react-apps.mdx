...
title_pt: 'Testando Aplicações React: Um Guia Prático'
...
summary_pt: 'De testes unitários a E2E—aprenda como construir confiança nas suas aplicações React com testes abrangentes.'
